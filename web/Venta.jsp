        ...
        <main>
            ...
            <div class="container">
                ...
                <form action="#" method="post" class="form-group" > 
                    ...
                    <label for="lbl_id_venta" ><b>ID VENTA</b></label>
                    ...
                    <input type="text" name="txt_nofactura" id="txt_nofactura" class="form-control" placeholder="Ejemplo: E001" pattern="[F]{1}[0-9]{3}" required>

                    <label for="lbl_Serie" ><b>SERIE</b></label>
                    <input type="text" name="txt_serie" id="txt_serie" class="form-control" placeholder="Ejemplo: S003" pattern="[S]{1}[0-9]{3}" required>

                    <label for="lbl_f_factura" ><b>FECHA FACTURACION</b></label>
                    <input type="date"  name="txt_f_factura" id="txt_f_factura" class="form-control" required>

                     <label for="lbl_id_cliente" ><b>ID CLIENTE</b></label>
                <select name="drop_id_cliente" id="drop_id_cliente" class="form-control">
                    <% 
                    ...
                    */
                    ...
                    <label for="lbl_id_empleado" ><b>ID EMPLEADO</b></label>
